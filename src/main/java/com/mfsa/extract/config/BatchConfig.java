...
import com.mfsa.extract.processor.PersonItenProcessor;
...
public class BatchConfig {
	...
	@Bean
	public Step step1(){
		return stepBuilderFactory.get("step1").<Person,Person>chunk(2).reader(reader()).processor(processor()).writer(itemWriter()).build();
	}
